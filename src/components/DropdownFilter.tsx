  ...
  return (
    <>
      <button onClick={onDropdownClick}
              className="text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-slate-800"
              type="button">
        {props.label}
      ...
      <div className={`${hiddenStateClass} absolute bg-white divide-y rounded-lg shadow dark:bg-gray-700`}>
